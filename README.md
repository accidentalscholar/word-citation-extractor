...
This script uses algorithmic pattern matching (commonly known as regular expressions or *regex*) to identify citations in the provided documents. It may not have achieved the *goldilocks* level, and I welcome feedback on what it gets wrong, especially if it helps me identify patterns, which in turn will allow me to improve its logic.

Primarily intended for *author-date* type referencing, this script is also intended to be servicable for footnote type of referencing.
